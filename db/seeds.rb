...
Payment.create(user_id: 1, amount: 999, reference_id: '123')
Payment.create(user_id: 2, amount: 999, reference_id: '123')
Payment.create(user_id: 3, amount: 999, reference_id: '123')
Payment.create(user_id: 4, amount: 999, reference_id: '123')
